  ...
  <body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <div class="app-wrapper">
     ...
     @include('parts/header')
      <!--end::Header-->
      <!--begin::Sidebar-->
       @include('parts/aside-scrollbars')
      <!--end::Sidebar-->
      <!--begin::App Main-->
      <main class="app-main">
                    ...
                    <div class="direct-chat-messages">
                      ...
                      <div class="direct-chat-msg">
                        ...
                        <img
                          ...
                          src="{{ Vite::asset('resources/images/img/user1-128x128.jpg') }}"
                      ...
                      <div class="direct-chat-msg end">
                        ...
                        <img
                          class="direct-chat-img"
                          src="{{ Vite::asset('resources/images/img/user3-128x128.jpg') }}"
                          alt="message user image"
                        />
                        <!-- /.direct-chat-img -->
                      ...
                      <ul class="contacts-list">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ Vite::asset('resources/images/img/user7-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ Vite::asset('resources/images/img/user5-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ Vite::asset('resources/images/img/user6-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
                        ...
                        <li>
                          <a href="#">
                            <img
                              class="contacts-list-img"
                              src="{{ Vite::asset('resources/images/img/user8-128x128.jpg') }}"
                              alt="User Avatar"
                            />
                            <div class="contacts-list-info">
                              <span class="contacts-list-name">
